...
const TopNavigation = ({ title, showBackButton = false }: TopNavigationProps) => {
  ...
  return (
    <header className="fixed top-0 left-1/2 transform -translate-x-1/2 w-full md:max-w-[375px] z-50 flex items-center justify-center h-14 bg-bg-light border-b border-border-base">
      {showBackButton && (
