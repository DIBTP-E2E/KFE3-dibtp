...
CREATE TABLE "chat_rooms" (
    ...
    "product_id" BIGINT NOT NULL,
    "seller_user_id" UUID NOT NULL DEFAULT gen_random_uuid(),
    "buyer_user_id" UUID NOT NULL DEFAULT gen_random_uuid(),
...
-- AddForeignKey
ALTER TABLE "chat_rooms" ADD CONSTRAINT "chat_rooms_product_id_fkey" FOREIGN KEY ("product_id") REFERENCES "products"("product_id") ON DELETE NO ACTION ON UPDATE NO ACTION;
